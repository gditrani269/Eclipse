...
<con:xqueryEntry xmlns:con="http://www.bea.com/wli/sb/resources/config">
    <con:xquery><![CDATA[(:: pragma bea:global-element-parameter parameter="$obtenerComisionCliente_11" element="ns1:ObtenerComisionCliente" location="../ObtenerComisionClienteRequest-1.0.0.xsd" ::)
...
xf:ObtenerComisionClienteRequest-1($obtenerComisionCliente_11)]]></con:xquery>
    <con:dependency location="../ObtenerComisionClienteRequest-1.0.0.xsd">
        <con:schema ref="OSB Project 1/ConsultaEspeciesOperativas/v1/ObtenerComisionClienteRequest-1.0.0"/>
    </con:dependency>
    <con:dependency location="../MFL/ObtenerComisionClienteRequest-1.0.0.mfl">
        <con:mfl ref="OSB Project 1/ConsultaEspeciesOperativas/v1/MFL/ObtenerComisionClienteRequest-1.0.0"/>
    </con:dependency>
</con:xqueryEntry>