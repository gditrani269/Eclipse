(:: pragma bea:mfl-element-parameter parameter="$obtenerCotizacionesMercadosResponse_11" type="ObtenerCotizacionesMercadosResponseError-1@" location="../MFL/ObtenerCotizacionesMercadosResponseError-1.0.0.mfl" ::)
...
xf:ObtenerCotizacionesMercadosResponseError-1($obtenerCotizacionesMercadosResponse_11)