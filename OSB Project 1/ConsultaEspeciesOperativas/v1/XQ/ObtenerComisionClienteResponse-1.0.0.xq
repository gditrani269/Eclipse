(:: pragma bea:mfl-element-parameter parameter="$obtenerComisionClienteResponse_11" type="ObtenerComisionClienteResponse-1@" location="../MFL/ObtenerComisionClienteResponse-1.0.0.mfl" ::)
...
xf:ObtenerComisionClienteResponse-1($obtenerComisionClienteResponse_11)