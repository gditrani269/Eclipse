(:: pragma bea:mfl-element-parameter parameter="$obtenerCotizacionesMercadosResponse_11" type="ObtenerCotizacionesMercadosResponse-1@" location="../MFL/ObtenerCotizacionesMercadosResponse-1.0.0.mfl" ::)
...
xf:ObtenerCotizacionesMercadosResponse-1($obtenerCotizacionesMercadosResponse_11)