(:: pragma bea:mfl-element-parameter parameter="$obtenerComisionClienteResponse_11" type="ObtenerComisionClienteResponseError-1@" location="../MFL/ObtenerComisionClienteResponseError-1.0.0.mfl" ::)
...
xf:ObtenerComisionClienteResponseError-1($obtenerComisionClienteResponse_11)