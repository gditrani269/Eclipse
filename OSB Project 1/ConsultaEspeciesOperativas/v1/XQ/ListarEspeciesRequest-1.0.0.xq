(:: pragma bea:global-element-parameter parameter="$listarEspecies_11" element="ns1:ListarEspecies" location="../ListarEspeciesRequest-1.0.0.xsd" ::)
...
xf:ListarEspeciesRequest-1($listarEspecies_11)